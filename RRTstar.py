...
#Cost(s_daughter) is the time it takes from s_parent vertex to s_daughter
...
# THIS IS DONE TWICE (i update it again later), IS IT REDUNDANT? 
...
#do you update costs here? 
 ...
 #wrong?   #cost[s_new] = cost[s_min] + metric(s_min, s_new)
            cost[s_new] = metric(s_min, s_new)
...
#!!! The line below IS NOT in Pseudocode!
     ...
     #wrong?    #cost[s_near] = cost[s_new]  + metric(s_new,s_near)
                cost[s_near] = metric(s_new,s_near)   
